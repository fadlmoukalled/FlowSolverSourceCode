...
c
      EquationOfState='idealgas' !'idealgas'  !'constant'
      BulkModulus=2.2d9
      RGas=287.05
      GammaGas=1.4
      PrLaminar=0.72
...
c      Pinlet=46040 !RhoInlet*Rgas*Tinlet                !1000. !0.*110.*133.3224
      ConstantDensity=0.  !for compressible flows it should be set to zero
